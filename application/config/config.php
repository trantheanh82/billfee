...
/* The Anh Config*/
$config['uploadFileScript_loaded'] = false;
$config['editorScript_loaded'] = false;
$config['upload_dir'] = '/assets/upload/';


/* * * Email Encrypt Connection * * * */
$config['email_encryption']['none'] = 'none';
$config['email_encryption']['TLS'] = 'TLS';
$config['email_encryption']['SSL'] = 'SSL';

/* * * */
$config['location']['hcm'] 	= 'Hồ Chí Minh';
$config['location']['hn'] 	= 'Hà Nội';
