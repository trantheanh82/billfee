	...
	<link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/admin/richfilemanager/src/css/libs-main.css" />
	<link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/admin/richfilemanager/src/css/filemanager.min.css" />
	...
	<style type="text/css">
		.fm-container .fm-loading-wrap {
			...
			left: 0;
			display: block;
			background: white url(<?=base_url()?>assets/admin/richfilemanager/images/spinner.gif) no-repeat center center;
			z-index: 999;
		}
	</style>
...
<div class="fm-container">
	...
	<div class="fm-wrapper">
		...
		<script type="text/javascript" src="<?=base_url()?>assets/admin/richfilemanager/src/js/libs-main.js"></script>
		<script type="text/javascript" src="<?=base_url()?>assets/admin/richfilemanager/src/js/filemanager.min.js"></script>
		<script type="text/javascript" src="<?=base_url()?>assets/admin/richfilemanager/config/filemanager.init.js"></script>
