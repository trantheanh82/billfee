					     	 ...
					     	 <div class="col-sm-8"> 
							    ...
							    ?>
							 	...
							 	<?php
							     	 	...
							     	 	case "image":
							     	 	echo "<div>";
							     	 		$this->load->view("admin/elements/modules/upload_image_view",array('field_id'=>$v->form_name,'id'=>$v->form_name,'value'=>$v->value,'multiple'=>false,'path'=>'/img','button_name'=>'Upload logo'));
							     	 	echo "</div>";
							     	 		break;
							     	 	case "checkbox":
